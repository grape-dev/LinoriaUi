...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"FF8800","BackgroundColor":"141414","OutlineColor":"323232"}') },
		['Green'] 			= { 2, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"00ff8b","BackgroundColor":"141414","OutlineColor":"323232"}') },
		['Red'] 			= { 3, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"ff4141","BackgroundColor":"141414","OutlineColor":"323232"}') },
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		--groupbox:AddInput('VideoLink', { Text = 'Video background link (.webm)', Default = self.Library.VideoLink });
		...
		groupbox:AddButton('Create theme', function() 
			...
			Options.ThemeManager_CustomThemeList:SetValue()
		...
		:AddButton('Reset default', function()
